...
1.  **설치**: SillyTavern의 확장 프로그램 설치 버튼으로 설치합니다.
2.  **설정**: 확장 프로그램 설정 메뉴에서 원하는 옵션을 활성화하고 조정합니다.
...
*   **테마 호환성**: 이 확장 프로그램은 기본적으로 사용자 테마와 호환되도록 설계되었으나, 메뉴 및 레이아웃 등 확장 프로그램이 직접 제어하는 일부 영역 외에는 사용자 테마 환경에 따라 CSS 충돌이 발생할 수 있습니다.
